...
function Movies() {
    ...
    return (
        <div className='movies-contain'>
            ...
            <Carousel className='ca' itemsToShow={4} renderArrow={Arrow} >
                <img src={m1} alt='carousel-img' className='caro' pagination='false'/>
                <img src={m3} alt='carousel-img' className='caro' pagination='false'/>
                <img src={m4} alt='carousel-img' className='caro' pagination='false'/>
                <img src={m5} alt='carousel-img' className='caro' pagination='false'/>
                <img src={m6} alt='carousel-img' className='caro' pagination='false'/>
                <img src={m7} alt='carousel-img' className='caro' pagination='false'/>
                <img src={m2} alt='carousel-img' className='caro' pagination='false'/>
            </Carousel>
            </div>
